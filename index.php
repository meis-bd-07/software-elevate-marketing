...
<head>
    <meta charset="utf-8">
    <title>Software Elevate - Marketing via call Agency Website Template</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Software Elevate, call tracking, marketing" name="keywords">
...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <!-- Navbar & Hero Start -->
        <?php require_once('components/IndexHeader.php') ?>
        <!-- Navbar & Hero End -->


        <!-- Full Screen Search Start -->
        <!-- <?php require_once('components/FullScreenSearch.php') ?> -->
